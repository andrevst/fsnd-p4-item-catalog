...
starship1 = Starships(name = "USS Enterprise", description = """Fisrt ship on
                      the series, commanded by Pyke and Kirk. Has Spock.""", 
                      category = "NCC-1701")

session.add(starship1)
session.commit()

starship2 = Starships(name = "USS Voyager", description = """Primary setting of
                      Star Trek: Voyager : (TV Series) . Commanded by 
                      Captain Kathryn Janeway. Commanded by Captain Chakotay in
...
starship3 = Starships(name = "USS Defiant", description = """The ship is lost 
                      in an interdimensional rift in "The Tholian Web".
...
starship4 = Starships(name = "ISS Enterprise", description = """Mirror Universe
                      version of Enterprise.""", category = "NCC-1701")

session.add(starship4)
session.commit()

starship5 = Starships(name = "USS Discovery", description = """The USS 
...
starship6 = Starships(name = "ISS Discovery", description = """Terran 
